...
import com.microboss.dev.avi.indicators.BallRotateIndicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mMinWidth = a.getDimensionPixelSize(0, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(0, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(0, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(0, mMaxHeight);
